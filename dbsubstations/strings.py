...
STRINGS_EL = {
    ...
    "MESSAGES": {
        ...
        "MANAGE_SUBELEMENTS_BTN": "Διαχείριση Υποστοιχείων",
        "ADD_SUBELEMENT_BTN": "Προσθήκη Υποστοιχείου",
        "ADD_SUBELEMENT_TITLE": "Προσθήκη Υποστοιχείου",
        "ADD_MANUAL": "Προσθήκη Manual",
        "EDIT_SUBELEMENT_MODEL_TITLE": "Επεξεργασία Μοντέλου Υποστοιχείου",
        "SUBELEMENT_MANAGEMENT_TITLE": "Διαχείριση Υποστοιχείων",
        "SUBELEMENT_MANAGEMENT_HINT": "Τα υποστοιχεία ανήκουν στους μετασχηματιστές και διαχειρίζονται ξεχωριστά.",
        "SUBELEMENT_PARENT_FAMILY_LABEL": "Γονική οικογένεια: Μετασχηματιστής",
        "SUBELEMENT_PARENT_FAMILIES_LABEL": "Γονικές οικογένειες",
        "TRANSFORMER_FAMILY_LABEL": "Μετασχηματιστής",
        "SUBELEMENT_TYPE_LABEL": "Τύπος Υποστοιχείου:",
        "SUBELEMENT_PARENT_ELEMENT_LABEL": "Γονικό στοιχείο",
        "PARENT_ELEMENT_NOT_FOUND": "Το γονικό στοιχείο δεν βρέθηκε.",
        "ADD_MENU_TITLE": "Προσθήκη υποσταθμών και στοιχείων",
        "ADD_MODEL_TITLE": "Προσθήκη Νέου Μοντέλου",
        "ELEMENT_MODELS_SECTION": "Μοντέλα Στοιχείων",
        ...
        "INSULATION_HINT": "0.0",
        "LAST_VALUE_LABEL": "Τελευταία τιμή:",
        "OPERATIONS_COUNT_HINT": "Αριθμός Χειρισμών",
        "OPERATIONS_COUNT_LABEL": "Αριθμός Χειρισμών:",
        ...
        "INCOMPLETE_MAINTENANCE_REMINDER_BODY_FMT": "Βρέθηκαν εκκρεμείς συντηρήσεις για τον υποσταθμό {substation_name}.\nΥπενθύμιση εργασιών που απομένουν:",
        "INCOMPLETE_MAINTENANCE_REMINDER_ITEM_FMT": "{index}. {name}\nΗμερομηνία: {date}{element_names_line}\nΕργασίες που απομένουν:\n{tasks}",
        ...
        "STARTUP_REPORT_REVIEW_TITLE": "Νέα e-mail αναφορά συντήρησης",
        "STARTUP_REPORT_REVIEW_MESSAGE_FMT": "Βρέθηκε e-mail αναφορά στο sync_root/reports.\n\nΑρχείο: {file_name}\nΘέμα: {subject}\nΑποστολέας: {sender}\nΗμ/νία: {received_at}\nΣυνημμένα: {attachment_count}\n\nΕπιλέξτε ενέργεια για την εγγραφή {index}/{total}.",
        "STARTUP_REPORT_REVIEW_PARSE_FAILED_FMT": "Το αρχείο δεν μπόρεσε να αναγνωριστεί ως .eml.\n\nΑρχείο: {file_name}\nΣφάλμα: {error}\n\nΜπορείτε να το παραλείψετε ή να το διαγράψετε.",
        "STARTUP_REPORT_DISCARD_CONFIRM_FMT": "Θέλετε να διαγράψετε οριστικά το αρχείο;\n\n{file_name}",
        "STARTUP_REPORT_DELETE_FAILED_FMT": "Η συντήρηση αποθηκεύτηκε, αλλά δεν ήταν δυνατή η διαγραφή του αρχείου e-mail.\n\nΑρχείο: {file_name}\nΣφάλμα: {error}",
        "STARTUP_EMAIL_REVIEW_TITLE": "Νέο e-mail για έλεγχο",
        "STARTUP_EMAIL_REVIEW_MESSAGE_FMT": "Βρέθηκε εκκρεμές {item_label} στο sync_root/{source_folder}.\n\nΑρχείο: {file_name}\nΘέμα: {subject}\nΑποστολέας: {sender}\nΗμ/νία: {received_at}\nΣυνημμένα: {attachment_count}\n\nΕπιλέξτε ενέργεια για την εγγραφή {index}/{total}.",
        "STARTUP_EMAIL_PARSE_FAILED_FMT": "Το αρχείο δεν μπόρεσε να αναγνωριστεί ως .eml.\n\nΑρχείο: {file_name}\nΣφάλμα: {error}\n\nΜπορείτε να το παραλείψετε ή να το διαγράψετε.",
        "STARTUP_EMAIL_DISCARD_CONFIRM_FMT": "Θέλετε να διαγράψετε οριστικά το αρχείο;\n\n{file_name}",
        "STARTUP_EMAIL_DELETE_FAILED_FMT": "Η εγγραφή {entry_label} αποθηκεύτηκε, αλλά δεν ήταν δυνατή η διαγραφή του αρχείου e-mail.\n\nΑρχείο: {file_name}\nΣφάλμα: {error}",
        "STARTUP_EMAIL_KIND_MAINTENANCE": "e-mail αναφορά συντήρησης",
        "STARTUP_EMAIL_KIND_ISOLATION": "e-mail αίτημα απομόνωσης",
        "STARTUP_EMAIL_ENTRY_MAINTENANCE": "συντήρησης",
        "STARTUP_EMAIL_ENTRY_ISOLATION": "απομόνωσης",
        ...
        "MODEL_FIELD_NUM_FMT": "Το πεδίο {field} πρέπει να είναι αριθμός!",
        ...
        "MODEL_CONNECTION_GROUP_LABEL": "Ομάδα Συνδεσμολογίας:",
        "MODEL_CONNECTION_GROUP_HINT": "π.χ. Dyn1",
        "MODEL_RATED_VOLTAGE_HV_LV_LABEL": "Ονομ. Τάση ΥΤ/ΜΤ:",
        "MODEL_RATED_VOLTAGE_HV_LV_HINT": "π.χ. 150/20 kV",
        "MODEL_MOUNTING_LABEL": "Τρόπος Εγκατάστασης:",
        "MODEL_MOUNTING_HINT": "π.χ. Outdoor",
        "MODEL_SPECIFICATION_LABEL": "Προδιαγραφή:",
        "MODEL_SPECIFICATION_HINT": "π.χ. IEC 60076",
        "MODEL_BIL_HV_LV_KV_LABEL": "BIL ΥΤ/ΜΤ (kV):",
        "MODEL_BIL_HV_LV_KV_HINT": "π.χ. 750/150",
        "MODEL_TOTAL_WEIGHT_KG_LABEL": "Συνολικό Βάρος (kg):",
        "MODEL_TOTAL_WEIGHT_KG_HINT": "π.χ. 69800",
        "MODEL_OIL_WEIGHT_KG_LABEL": "Βάρος Ελαίου (kg):",
        "MODEL_OIL_WEIGHT_KG_HINT": "π.χ. 25990",
        "MODEL_RATED_NORMAL_CURRENT_A_LABEL": "Ονομ. Ρεύμα (A):",
        "MODEL_RATED_NORMAL_CURRENT_A_HINT": "π.χ. 1250",
        "MODEL_RATED_SHORT_CIRCUIT_BREAKING_CURRENT_KA_LABEL": "Ρεύμα Διακοπής Βραχ. Κυκλ. (kA):",
        "MODEL_RATED_SHORT_CIRCUIT_BREAKING_CURRENT_KA_HINT": "π.χ. 40",
        "MODEL_SHORT_CIRCUIT_DURATION_S_LABEL": "Διάρκεια Βραχ. Κυκλ. (s):",
        "MODEL_SHORT_CIRCUIT_DURATION_S_HINT": "π.χ. 3",
        "MODEL_MAKING_CAPACITY_KA_LABEL": "Ικανότητα Ζεύξης (kA):",
        "MODEL_MAKING_CAPACITY_KA_HINT": "π.χ. 100",
        "MODEL_SF6_PRESSURE_RATED_BAR_LABEL": "Ονομ. Πίεση SF6 (bar):",
        "MODEL_SF6_PRESSURE_RATED_BAR_HINT": "π.χ. 6.0",
        "MODEL_DRIVE_MECHANISM_LABEL": "Μηχανισμός Κίνησης:",
        "MODEL_DRIVE_MECHANISM_HINT": "π.χ. FK 3-1",
        "MODEL_RATED_SHORT_CIRCUIT_MAKING_CURRENT_KA_LABEL": "Ρεύμα Ζεύξης Βραχ. Κυκλ. (kA):",
        "MODEL_RATED_SHORT_CIRCUIT_MAKING_CURRENT_KA_HINT": "π.χ. 40",
        "MODEL_CUBICLE_LABEL": "Κυψέλη:",
        "MODEL_CUBICLE_HINT": "π.χ. 23",
...
STRINGS_EN = {
    ...
    "MESSAGES": {
        ...
        "SELECT_MAINT_RESPONSIBLE": "Select maintenance responsible:",
        "UNDONE_MAINTENANCES_LABEL": "Undone Maintenances",
        "TASKS_LEFT_LABEL": "Tasks left",
        "INCOMPLETE_MAINTENANCE_REMINDER_TITLE": "Incomplete maintenance reminder",
        "INCOMPLETE_MAINTENANCE_REMINDER_BODY_FMT": "Incomplete maintenances were found for substation {substation_name}.\nRemaining tasks reminder:",
        "INCOMPLETE_MAINTENANCE_REMINDER_ITEM_FMT": "{index}. {name}\nDate: {date}{element_names_line}\nTasks left:\n{tasks}",
        ...
        "STARTUP_REPORT_REVIEW_TITLE": "New Maintenance E-mail Report",
        "STARTUP_REPORT_REVIEW_MESSAGE_FMT": "An e-mail report was found in sync_root/reports.\n\nFile: {file_name}\nSubject: {subject}\nSender: {sender}\nReceived: {received_at}\nAttachments: {attachment_count}\n\nChoose an action for item {index}/{total}.",
        "STARTUP_REPORT_REVIEW_PARSE_FAILED_FMT": "The file could not be parsed as .eml.\n\nFile: {file_name}\nError: {error}\n\nYou can skip it or delete it.",
        "STARTUP_REPORT_DISCARD_CONFIRM_FMT": "Delete this e-mail file permanently?\n\n{file_name}",
        "STARTUP_REPORT_DELETE_FAILED_FMT": "The maintenance was saved, but the source e-mail file could not be deleted.\n\nFile: {file_name}\nError: {error}",
        "STARTUP_EMAIL_REVIEW_TITLE": "New Pending E-mail",
        "STARTUP_EMAIL_REVIEW_MESSAGE_FMT": "A pending {item_label} was found in sync_root/{source_folder}.\n\nFile: {file_name}\nSubject: {subject}\nSender: {sender}\nReceived: {received_at}\nAttachments: {attachment_count}\n\nChoose an action for item {index}/{total}.",
        "STARTUP_EMAIL_PARSE_FAILED_FMT": "The file could not be parsed as .eml.\n\nFile: {file_name}\nError: {error}\n\nYou can skip it or delete it.",
        "STARTUP_EMAIL_DISCARD_CONFIRM_FMT": "Delete this e-mail file permanently?\n\n{file_name}",
        "STARTUP_EMAIL_DELETE_FAILED_FMT": "The {entry_label} entry was saved, but the source e-mail file could not be deleted.\n\nFile: {file_name}\nError: {error}",
        "STARTUP_EMAIL_KIND_MAINTENANCE": "maintenance e-mail report",
        "STARTUP_EMAIL_KIND_ISOLATION": "isolation request e-mail",
        "STARTUP_EMAIL_ENTRY_MAINTENANCE": "maintenance",
        "STARTUP_EMAIL_ENTRY_ISOLATION": "isolation request",
        ...
        "MODEL_FIELD_NUM_FMT": "Field {field} must be a number!",
        "MODEL_POWER_NUM": "Rated power must be a number!",
        "MODEL_CONNECTION_GROUP_LABEL": "Connection Group:",
        "MODEL_CONNECTION_GROUP_HINT": "e.g. Dyn1",
        "MODEL_RATED_VOLTAGE_HV_LV_LABEL": "Rated Voltage HV/LV:",
        "MODEL_RATED_VOLTAGE_HV_LV_HINT": "e.g. 150/20 kV",
        "MODEL_MOUNTING_LABEL": "Mounting:",
        "MODEL_MOUNTING_HINT": "e.g. Outdoor",
        "MODEL_SPECIFICATION_LABEL": "Specification:",
        "MODEL_SPECIFICATION_HINT": "e.g. IEC 60076",
        "MODEL_BIL_HV_LV_KV_LABEL": "BIL HV/LV (kV):",
        "MODEL_BIL_HV_LV_KV_HINT": "e.g. 750/150",
        "MODEL_TOTAL_WEIGHT_KG_LABEL": "Total Weight (kg):",
        "MODEL_TOTAL_WEIGHT_KG_HINT": "e.g. 69800",
        "MODEL_OIL_WEIGHT_KG_LABEL": "Oil Weight (kg):",
        "MODEL_OIL_WEIGHT_KG_HINT": "e.g. 25990",
        "MODEL_RATED_NORMAL_CURRENT_A_LABEL": "Rated Normal Current (A):",
        "MODEL_RATED_NORMAL_CURRENT_A_HINT": "e.g. 1250",
        "MODEL_RATED_SHORT_CIRCUIT_BREAKING_CURRENT_KA_LABEL": "Rated Short-Circuit Breaking Current (kA):",
        "MODEL_RATED_SHORT_CIRCUIT_BREAKING_CURRENT_KA_HINT": "e.g. 40",
        "MODEL_SHORT_CIRCUIT_DURATION_S_LABEL": "Short-Circuit Duration (s):",
        "MODEL_SHORT_CIRCUIT_DURATION_S_HINT": "e.g. 3",
        "MODEL_MAKING_CAPACITY_KA_LABEL": "Making Capacity (kA):",
        "MODEL_MAKING_CAPACITY_KA_HINT": "e.g. 100",
        "MODEL_SF6_PRESSURE_RATED_BAR_LABEL": "Rated SF6 Pressure (bar):",
        "MODEL_SF6_PRESSURE_RATED_BAR_HINT": "e.g. 6.0",
        "MODEL_DRIVE_MECHANISM_LABEL": "Drive Mechanism:",
        "MODEL_DRIVE_MECHANISM_HINT": "e.g. FK 3-1",
        "MODEL_RATED_SHORT_CIRCUIT_MAKING_CURRENT_KA_LABEL": "Rated Short-Circuit Making Current (kA):",
        "MODEL_RATED_SHORT_CIRCUIT_MAKING_CURRENT_KA_HINT": "e.g. 40",
        "MODEL_CUBICLE_LABEL": "Cubicle:",
        "MODEL_CUBICLE_HINT": "e.g. 23",
        ...
        "INSULATION_HINT": "0.0",
        "LAST_VALUE_LABEL": "Last value:",
        "OPERATIONS_COUNT_HINT": "Operation Count",
        "OPERATIONS_COUNT_LABEL": "Operation Count:",
        ...
        "LOC": "Location",
        "ADOPTION": "Adoption",
        "BASE_DISTANCE_KM_LABEL": "Distance from base (km):",
        "BASE_DISTANCE_KM_SHORT": "Distance (km)",
        "INFO": "Details",
        "GATES": "Gates",
        ...
        "TOOLTIP_MANUAL": "Manual",
        "TOOLTIP_SUBELEMENTS": "Subelements",
        "VIEW_SHORT": "View",
        "PDF_BUTTON": "PDF",
