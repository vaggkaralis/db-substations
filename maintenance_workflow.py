...
def summarize_workflow(
    ...
    *,
    ...
    if completed:
        ...
        next_action = "Συμπληρώστε τον τίτλο και κλείστε τη συντήρηση όταν ολοκληρωθούν τα στοιχεία και τα συνημμένα."
    elif pending_tasks_text:
        next_action = "Η συντήρηση μένει ανοιχτή. Κρατήστε τον τίτλο ενημερωμένο και κλείστε την όταν μηδενιστούν οι εκκρεμότητες."
    else:
        next_action = "Συμπληρώστε τον τίτλο και κλείστε τη συντήρηση όταν ολοκληρωθούν τα στοιχεία και τα συνημμένα."
