...
def test_integrity_check_missing_table():
    ...
    try:
        ...
        assert any("missing" in err.lower() for err in result.errors), "Should report missing tables"
...
def test_integrity_check_orphaned_elements():
    ...
    try:
        ...
        assert any("orphan" in err.lower() or "non-existent" in err.lower() 
                   for err in result.errors), "Should report orphaned elements"
