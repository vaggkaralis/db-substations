...
STRINGS_EL = {
    ...
    "MESSAGES": {
        ...
        "MAINTENANCE_TYPES": ['Επαναληπτική συντήρηση', 'Βλάβη', 'Φυσικοχημικές/Αεριοχρωματογραφία'],
        ...
        "SORT_OPTIONS": ['Ημερομηνία (φθίνουσα)', 'Ημερομηνία (αύξουσα)', 'Υποσταθμός A-Ω'],
        ...
        "TEMPLATE_ELEMENTS_EXAMPLES": [('Υποσταθμός Α', 'Διακόπτης ΜΤ', 'Main Breaker', 'SN-001', '2025-01-20', 'SF6', 'Κεντρικός', 'Ενεργή', 'ΠΥΛΗ 1', 'SF6-400', 'ABB', 'Εσωτερικού'), ('Υποσταθμός Α', 'Μετασχηματιστής 150/20KV', 'Transformer 1', 'SN-002', '2025-01-18', '', '', 'Ενεργή', 'ΠΥΛΗ 1', 'GEAFOL', 'Siemens', 'Εξωτερικού')],
        ...
        "TEMPLATE_SUBSTATIONS_EXAMPLES": [('Υποσταθμός Α', 'https://maps.google.com/?q=example1', '2025-01-15'), ('Υποσταθμός Β', 'https://maps.google.com/?q=example2', '2025-01-20')],
...
STRINGS_EN = {
    ...
    "MESSAGES": {
        ...
        "MAINTENANCE_TYPES": ["Recurring maintenance", "Fault", "Physicochemical/Gas Chromatography"],
