...
STRINGS_EL = {
    ...
    "MESSAGES": {
        ...
        "STARTUP_SYNC_DEFERRED_TOAST": 'Ο συγχρονισμός εκκίνησης αναβλήθηκε. Μπορείτε να εκτελέσετε συγχρονισμό χειροκίνητα από το μενού Εισαγωγή/Sync.',
        "STARTUP_SYNC_DEFERRED_ACTION": 'Άνοιγμα Εισαγωγή/Sync',
...
STRINGS_EN = {
    ...
    "MESSAGES": {
        ...
        "STARTUP_SYNC_DEFERRED_TOAST": "Startup sync was deferred. You can run sync manually from the Import/Sync menu.",
        "STARTUP_SYNC_DEFERRED_ACTION": "Open Import/Sync",
