...
STRINGS_EL = {
    ...
    "MESSAGES": {
        ...
        "IMPORT_SYNC_INBOX_BUTTON": 'Επεξεργασία εισερχομένων OneDrive',
        ...
        "IMPORT_EXPORT_DB_BUTTON": 'Εξαγωγή Βάσης (Excel)',
...
STRINGS_EN = {
    ...
    "MESSAGES": {
        ...
        "IMPORT_MENU_PROMPT": "Select what you want to import:",
        "IMPORT_ELEMENTS_BUTTON": "Import Elements from File",
        "IMPORT_EXPORT_DB_BUTTON": "Export Database (Excel)",
        ...
        "IMPORT_SYNC_INBOX_BUTTON": "Process OneDrive inbox",
